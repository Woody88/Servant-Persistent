...
/* package servant-persistent-0.1.0.0 */
#define VERSION_servant_persistent "0.1.0.0"
#define MIN_VERSION_servant_persistent(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package servant-js-0.9.3.1 */
#define VERSION_servant_js "0.9.3.1"
...
#define CURRENT_COMPONENT_ID "servant-persistent-0.1.0.0-F9U6X9AVPnS7puEgXNTfgZ"

#define CURRENT_PACKAGE_KEY "servant-persistent-0.1.0.0-F9U6X9AVPnS7puEgXNTfgZ"
